...
namespace NeoErp.Planning.Service.Models
{
    ...
    public class COAPlanViewModal_Grid
    {
    ...
    public class COAPlanDtlViewModal
    {
        public int PLAN_CODE { get; set; }
        public DateTime PLAN_DATE { get; set; }
        public decimal? PER_DAY_AMOUNT { get; set; }//DEFAULT NULL,
    ...
    public class FA_CHART_OF_ACCOUNTS_SETUP
    {
        public string ACC_CODE { get; set; }
    ...
    public class COATree
    {
        ...
        public IEnumerable<COATree> Items { get; set; }
    }
    public class COAPlanItems
    {
    ...
    public class COAPlanSetupDetailViewModal
    {
        public virtual COAPlanViewModal CoaPlan { get; set; }
        public virtual List<COAPlanDtlViewModal> CoaPlanDtlList { get; set; }

        public virtual List<COAPlanItems> CoaPlanItems { get; set; }
    }

    public class PlanCOARefrenceModel
    {
