...
namespace NeoErp.Planning.Service.Models
{
    public class CollectionPlan
    {
        ...
        public List<CollectionPlanItems> selectedItemsList { get; set; }
        public List<CollectionPlanDetail> salesPlanDetail { get; set; }
    }
    public class PL_BRD_CLTN_PLAN
    {
    ...
    public class CollectionPlanDetail
    {
        public string PLAN_CODE { get; set; }
        public DateTime PLAN_DATE { get; set; }
        public string PER_DAY_AMOUNT { get; set; }//DEFAULT NULL,
        public string ITEM_CODE { get; set; }
    ...
    public class CollectionPlanItems
    {
    ...
    public class CollectionPlanTreeReportModel
    {
        public string CUSTOMER_CODE { get; set; }
        public string CUSTOMER_EDESC { get; set; }
    ...
    public class CollectionPlanSetupDetailViewModal
    {
        public virtual PL_BRD_CLTN_PLAN CollectionPlan { get; set; }
        public virtual List<CollectionPlanDetail> CollectionPlanDtlList { get; set; }
        public virtual List<CollectionPlanItems> CollectionPlanItems { get; set; }
    }
    ...
    public class CollectionTree
    {
        ...
        public IEnumerable<CollectionTree> Items { get; set; }
    }
    public class CollectionSetupModel
    {
        public int LEVEL { get; set; }
        public string ItemName { get; set; }
    ...
    public class PlanCollectionRefrenceModel
    {
    ...
    public class CollectionFromMaterialModel
    {
        public string ITEM_CODE { get; set; }
        public string ITEM_EDESC { get; set; }
    ...
    public class CollectionFromMaterialParam
    {
        public string PLAN_CODE { get; set; }
    }
}
