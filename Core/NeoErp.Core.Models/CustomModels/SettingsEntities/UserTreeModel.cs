...
namespace NeoErp.Core.Models.CustomModels.SettingsEntities
{
    ...
    public class AvailableControl
    {
        ...
        public bool NEW {
            ...
            get { return this.pNew; }
            set {
                pNew = Convert.ToBoolean(value);
            }
        } 
        public string NEW1 { get; set; } = string.Empty;
        public string REPORTSTO { get; set; }
        public bool VIEW { get; set; } = false;
        public string VIEW1 { get; set; } = string.Empty;
        public bool EDIT { get; set; } = false;
        public string EDIT1 { get; set; } = string.Empty;
        public bool RECYCLE { get; set; } = false;
        public string RECYCLE1 { get; set; } = string.Empty;
        public bool POSTPRINT { get; set; } = false;
        public string POSTPRINT1 { get; set; } = string.Empty;
        public bool UNPOST { get; set; } = false;
        public string UNPOST1 { get; set; } = string.Empty;
        public bool CHECK { get; set; } = false;
        public string CHECK1 { get; set; } = string.Empty;
        public bool VERIFY { get; set; } = false;
        public string VERIFY1 { get; set; } = string.Empty;
