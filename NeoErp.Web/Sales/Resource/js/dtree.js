...
(function ( $ ) {
    ...
    $.fn.dTree = function(options) {
        ...
        return this.each(function() {
            ...
            $folder.prepend("<span class=\"add\"></span><span class=\"folder\"></span>");
            ...
            $(this).on('click', '.add, .minus', function(){
    ...
    $.fn.dTree.set_icons = function($selected) 
    {
        ...
        {
            $selected.removeClass("add").addClass("minus");
            $selected.siblings("span").removeClass("folder").addClass("folder-open");
        }
        else
        {
            $selected.removeClass("minus").addClass("add");
    ...
    {
         $selected.children("span.join");
         $selected.children("span").addClass("folder-open").removeClass("page");
    };
