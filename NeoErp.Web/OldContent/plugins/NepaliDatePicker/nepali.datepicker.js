...
return a}function getMonthParameters(t){var e=t.split(sep),s=e[0],a=e[1]
$("#currentMonth").html(getNepaliMonth(a-1)+"&nbsp;"+englishNo2Nep(s)),nYear=pYear=s,nMonth=parseInt(a,10)+1,nMonth>12&&(nYear++,nMonth="01"),pMonth=parseInt(a,10)-1,1>pMonth&&(pYear--,pMonth="12"),$("#prev").attr("onclick","showCalendar('"+pYear+sep+pMonth+sep+"01')"),$("#next").attr("onclick","showCalendar('"+nYear+sep+nMonth+sep+"01')")
var n=e[2],r=numberOfBsDays(s,a-1),i=new NepaliDateConverter,h=a+"/"+"1"+"/"+s,d=i.bs2ad(h),o=d.split(sep),b=o[0],u=o[1],c=o[2],l=new Date(b,u-1,c),p=l.getDay()
return[p,r,s,a,n]}function getDateRows(t,e,s,a,n){var r=getNepaliDate(),i=r.split(sep)
i[0]
for(var h=get2DigitNo(i[1]),d=get2DigitNo(i[2]),o="",b=0;t+e>b;b++){0==b%7&&(o+="<tr>")
var u=b-t+1,c=""+s+sep+get2DigitNo(a)+sep+get2DigitNo(u),l=""
...
return s[0]="Sunday",s[1]="Monday",s[2]="Tuesday",s[3]="Wednesday",s[4]="Thursday",s[5]="Friday",s[6]="Saturday",s[e]}function getDayFromDate(t){var e=t.split(sep),s=e[2],a=e[1],n=e[0],r=new Date(n,a-1,s),i=r.getDay(),h=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"]
...
return a+t+s+t+n}function getAdDateInWords(t){var e=getMonths(),s=t.split(sep),a=s[2],n=s[1],r=s[0]
return a+" "+e[n]+", "+r}function getNepaliDateInWords(t){var e=getNepaliMonths(),s=t.split(sep),a=s[2],n=s[1],r=s[0]
