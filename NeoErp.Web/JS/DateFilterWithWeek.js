var DateFilter = function () {
    ...
    return {
        ...
        loadDateFilter: function (selector, callback) {
            ...
            var readUrl = window.location.protocol + "//" + window.location.host + "/api/Common/GetDateFiltersWithWeek?fiscalYear=" + currentFiscalYear;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var ddlselector = $(selector + " option[value='This Year']")
