distributionModule.controller("SalesTargetvsAchievement", function ($scope, $filter, $timeout, crudAJService) {
    debugger;
    ...
    $("#grid").kendoGrid({
       dataSource: {
                transport: {
                    read: {
                        url: window.location.protocol + "//" + window.location.host + "/api/Distributor/GetAllSalesTargetVsAchievement",
    ...
    //        excel: {
    //            fileName: "Sales Target vs Achievement",
    //            allPages: true,
    //        },
    //        height: window.innerHeight - 50,
    //        groupable: true,
