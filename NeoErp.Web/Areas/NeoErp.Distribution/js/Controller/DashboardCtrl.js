//var distributionModule = angular.module('distributionModule', ['kendo.directives']);
var moduleCode = "10";
distributionModule.controller('dynamicCtrl', function ($scope, distributorService, $routeParams) {
    ...
    Getdata.then(function (response) {
      ...
      //  document.distParentData = $scope.dynamicMenu;
    });
