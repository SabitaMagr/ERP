                    ...
                    for (var a = 0; a < budgetResult.data.length; a++) {
                        ...
                        for (var b = 0; b < $scope.dynamicModalData.length; b++) {
                            ...
                            if (budgetResult.data[a].ACC_CODE == $scope.dynamicModalData[b].ACC_CODE) {
                                ...
                                //if (serialno == b) {
                                $scope.dynamicModalData[b].BUDGET[a] = $scope.getObjWithKeysFromOtherObj(budgetChildModel, budgetResult.data[a]);
                                //if ($scope.dynamicModalData[b].BUDGET[a].BUDGET_CODE != "") {
                                //    var budreqq = "/api/TemplateApi/GetBudgetNameByBCode?code=" + $scope.dynamicModalData[b].BUDGET[a].BUDGET_CODE;
                                //    $http.get(budreqq).then(function (budresultss) {
                                //        setTimeout(function () {

                                //            $("#BUDGETCODE_" + a).data('kendoComboBox').dataSource.data([{ BUDGET_CODE: $scope.dynamicModalData[b].BUDGET[a].BUDGET_CODE, BUDGET_EDESC: budresultss.data, Type: "code" }]);                                              
                                //        }, 4000);
                                //    });
                                //}


                                //$scope.dynamicModalData[b].SERIAL_NO = b + 1;
                                //}
                            }
                        }
                    }
