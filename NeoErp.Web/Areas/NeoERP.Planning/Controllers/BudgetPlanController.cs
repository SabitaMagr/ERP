...
namespace NeoERP.Planning.Controllers
{
    public class BudgetPlanController : Controller
    {
        ...
        public BudgetPlanController(ICOAPlanRepo COAPlanRepo)
        {
        ...
        public ActionResult FavLedgerPlanReport()
        {
            return PartialView();
        }
        public ActionResult CreateBudgetPlan(string plancode)
        {
        ...
        public ActionResult BudgetPlanSetup(string planCode)
        {
            ViewBag.planCode = planCode;
            return View();
        }
        ...
        {
            //SalesPlan result = this._COAPlanRepo.GetPlanDetailValueByPlanCode(planCode);
        ...
        public JsonResult CopyPlan(FormCollection formData)
        {
            ...
            {
                copied = this._COAPlanRepo.cloneSalesPlan(planCode, planName, branchs, divisions, remarks);
            }
            else
            {
                copied = false;
        ...
        public ActionResult LoadBudgetPlanSetupTreeListPartial(string startDate, string endDate, string timeFrameCode, string timeFrameName, string datetype)
        {
            return PartialView("~/Areas/NeoERP.Planning/Views/BudgetPlan/_BudgetPlanSetupTreeList.cshtml");
        }

        public string saveBudgetPlan(FormCollection fc)
        {
            ...
            if (parentArr.Count > 0)
                ...
                return result = this._COAPlanRepo.SaveBudgetPlan(parentArr, sp);
            else
                return "error";
        }
