...
{
    public class BrandingPlanController : Controller
    {
        public IPlanSetup _iPlanSetup { get; set; }
        public IPlan _plan;
        IBrandingPlanRepo _BrandingPlanRepo;
        public BrandingPlanController(IPlanSetup iPlanSetup, IBrandingPlanRepo BrandingPlanRepo, IPlan PlanRepo)
        {
        ...
        public ActionResult FavBrandingPlanReport()
        {
            return PartialView();
        }
        public ActionResult CreateBrandingPlan(string plancode)
        {
        ...
        public ActionResult BrandingPlanSetup(string planCode)
        {
            ViewBag.planCode = planCode;
        ...
        {
             return PartialView("~/Areas/NeoERP.Planning/Views/BrandingPlan/_BrandingPlanSetupTreeList.cshtml");
        }

        public string SaveBrandingPlan(FormCollection fc)
        {
            ...
            BrandingPlan sp = new BrandingPlan()
            {
            ...
            if (parentArr.Count > 0)
                ...
                return result = this._BrandingPlanRepo.SaveBrandingPlan(parentArr, sp);
            else
                return "error";
        }
        ...
        {
            var model = this._iPlanSetup.GetPreferenceSetups();
            COAPlanSetupDetailViewModal result = this._BrandingPlanRepo.GetBudgetPlanDetailValueByPlanCode(planCode);
            ViewBag.planCode = planCode;
            return PartialView(model);
        }
        [HttpPost]
        public JsonResult CopyPlan(FormCollection formData)
        {
            ...
            {
                copied = this._BrandingPlanRepo.cloneBrandingPlan(planCode, planName, customers, employees, branchs, divisions, remarks);
