planningModule.controller('ProcureFromMaterialCtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    $scope.pageName = "Procurement from material";
    ...
    $scope.saveProcureFromMaterial = function (isValid) {
        ...
        if (valid) {
            showloader();
            var savePlanUrl = window.location.protocol + "//" + window.location.host + "/ProcurementPlan/SaveProcurementPlan";//window.location.protocol + "//" + window.location.host + "/MaterialPlan/SaveMaterialPlans";
            //var params = {
