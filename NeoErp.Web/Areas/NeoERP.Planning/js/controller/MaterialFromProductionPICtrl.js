/*eslint-disable*/
planningModule.controller('MaterialFromProductionPICtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    debugger;
            ...
            grid = $("#grid").kendoGrid({
                ...
                dataBound: function (o) {
                    ...
                    if (grid.dataSource.data().length > 0) {
                        checkedItems = [];
                        $scope.chresult = grid.dataSource.data();
                        debugger;
                        var griddata = $.grep($scope.chresult, function (e) {
                        ...
                        if (griddata.length > 0) {
                            for (var i = 0; i < griddata.length; i++) {
                                ...
                                checkedItems.push({
                                    ...
                                    "MU_CODE": griddata[i].INDEX_MU_CODE,
                                    "QUANTITY": griddata[i].PO
                                });
                            }
                        }
    ...
    $scope.generatePI = function () {
        debugger;
        checkedItems;
        var model = {
            FROM_DEPARTMENT: $scope.fromdepartment,
            TO_DEPARTMENT: $scope.todepartment,
            checkList: checkedItems,
        };
        var url = window.location.protocol + "//" + window.location.host + "/api/MaterialPlanApi/GeneratePI";
