...
planningModule.controller('BudgetPlanCtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    ...
    function getFlagFromPreferenceSetup() {
        ...
        $http(req).then(function (data, status, headers, config) {
            $scope.branchFlag = data.data.DATA[4].SHOW_BRANCH;
            $scope.employeeFlag = data.data.DATA[4].SHOW_EMPLOYEE;
            $scope.customerFlag = data.data.DATA[4].SHOW_CUSTOMER;
            $scope.itemflag = data.data.DATA[4].SHOW_ITEM;
