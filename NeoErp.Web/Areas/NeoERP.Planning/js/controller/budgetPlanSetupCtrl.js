...
planningModule.controller('budgetPlanSetupCtrl', function ($scope, $routeParams, $rootScope) {
    ...
    $scope.gotoBack = function () {
        ...
        if (confirm("All input data will lost, Are you sure to go back?")) {
            if ($routeParams.plancode != '' && $routeParams.plancode != undefined && $routeParams.plancode != 'undefined') {
                window.location = "/Planning/Home/Index#!Planning/CreateBudgetPlan/" + $routeParams.plancode;
            }
            else {
                window.location = "/Planning/Home/Index#!Planning/CreateBudgetPlan";
            }
        }
    }

    $scope.cancelForm = function () {
        window.location.href = "/Planning/Home/Setup#!Planning/BudgetPlan";
    }
});
