planningModule.controller('ProcurementPlanSetupCtrl', function ($scope, plansetupservice, $routeParams,$http,$rootScope) {
    ...
    $scope.gotoBack = function () {
        ...
        if (confirm("All input data will lost, Are you sure to go back?")) {
            ...
            if ($routeParams.plancode != '' && $routeParams.plancode != undefined && $routeParams.plancode != 'undefined') {
                if (fromRef != "")
                    window.location = "/Planning/Home/Index#!Planning/CreateProcurementPlan/" + $routeParams.plancode + fromRef;
                else
                    window.location = "/Planning/Home/Index#!Planning/CreateProcurementPlan/" + $routeParams.plancode;
            }
            else {
                if (fromRef != "")
                    window.location = "/Planning/Home/Index#!Planning/CreateProcurementPlan"+ fromRef;
                else
                    window.location = "/Planning/Home/Index#!Planning/CreateProcurementPlan";
    ...
    $scope.cancelForm = function () {
        window.location.href = "/Planning/Home/Setup#!Planning/ProcurementPlan";
    }
});
