...
planningModule.controller('planningLedgerBudgetCtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    ...
    $scope.accountDataSource = {
        ...
        transport: {
            read: {
                dataType: "json",
                url: "/api/SubPlanApi/getAllAccountSetup",
            },
            parameterMap: function (data, action) {
                if (data.filter != undefined) {
                    if (data.filter.filters[0] != undefined) {
