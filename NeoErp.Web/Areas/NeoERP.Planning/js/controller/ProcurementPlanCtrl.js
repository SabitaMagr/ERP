planningModule.controller('ProcurementPlanCtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    ...
    function getFlagFromPreferenceSetup() {
        var url = window.location.protocol + "//" + window.location.host + "/api/PlanApi/GetProcuremntPreferenceSetupFlag";
        var req = {
            method: 'GET',
            url: url,
        }
    ...
    $scope.pageName = "New Procurement Plan";
            ...
            if (itemLength < parseInt(productSelectionLimit)) {
                if ($scope.param != '' && $scope.param != undefined && $scope.param != 'undefined') {
                    if (planName != undefined && planName != "" && ref != undefined && ref != "")
                        window.location.href = "/Planning/Home/Index#!Planning/ProcurementPlanSetup/" + $scope.param + manualRef;
                    else
                        window.location.href = "/Planning/Home/Index#!Planning/ProcurementPlanSetup/" + $scope.param;
                } else {
                    if (planName != undefined && planName != "" && ref != undefined && ref != "")
                        window.location.href = "/Planning/Home/Index#!Planning/ProcurementPlanSetup" + manualRef;
                    else
                        window.location.href = "/Planning/Home/Index#!Planning/ProcurementPlanSetup";
                }
            }
            else {
    ...
    if (tempValue != undefined) {
        ...
        $.ajax({
            ...
            $scope.planfor = ret.SALES_AMOUNT != null ? 'QUANTITY' : 'QUANTITY';
