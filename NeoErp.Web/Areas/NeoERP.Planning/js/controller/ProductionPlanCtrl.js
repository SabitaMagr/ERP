planningModule.controller('ProductionPlanCtrl', function ($scope, planservice, $routeParams, $rootScope, $http) {
    ...
    function getFlagFromPreferenceSetup() {
        var url = window.location.protocol + "//" + window.location.host + "/api/PlanApi/GetproductionPreferenceSetupFlag";
        var req = {
            method: 'GET',
            url: url,
        }
    ...
    $scope.pageName = "New Production Plan";
    ...
    function IsFormValid() {
        ...
        //else if ((employeeSelected == "" || employeeSelected == null) && loggedInUsers_employeeCode == "") {
        //    return false;
        //}
        else if (count < 1) {
            return false;
        ...
        if (Isvalid) {
            ...
            if (itemLength < parseInt(productSelectionLimit)) {
                if ($scope.param != '' && $scope.param != undefined && $scope.param != 'undefined') {
                    window.location.href = "/Planning/Home/Index#!Planning/ProductionPlanSetup/" + $scope.param;
                } else {
                    window.location.href = "/Planning/Home/Index#!Planning/ProductionPlanSetup";
                }
            }
            else {
    ...
    if (tempValue != undefined) { 
        ...
        showloader();
        $.ajax({
            url: '/api/ProductionPlanApi/GetPlanDetailValueByPlanCode',
