PMModule.controller('Requisition', function ($scope, $rootScope, $http, $routeParams, inventoryservice, inventoryfactory, $window, $filter, hotkeys) {
    ...
    $scope.SaveDocumentFormData = function (param) {
        ...
        return response.then(function (data) {
            if (data.data.MESSAGE == "INSERTED") {
                ...
                $window.location.href = window.location.protocol + "//" + window.location.host + "/ProjectManagement/Home/Index#!PM/ReqMenuSplitter/" + $scope.ModuleCode; /*done previously*/
                //setTimeout(function () {
