PMModule.controller('requisitionReport', function ($scope, $window, $http, $filter, $timeout) {

    var response = $http.get('/api/ProjectApi/GetRequisitionDetails?formcode=160');
    ...
    function initializeKendoGrid() {
        ...
        $("#kGrid").kendoGrid({
            ...
            toolbar: ["excel"],
            excel: {
                fileName: "Requisition Slip Report.xlsx",
                allPages: true
            },
            columns: [
