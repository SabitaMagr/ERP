PMModule.controller('consumptionReport', function ($scope, $window, $http, $filter, $timeout) {

    var response = $http.get('/api/ProjectApi/GetConsumptionDetails?formcode=649');
    ...
    function initializeKendoGrid() {
        ...
        $("#kGrid").kendoGrid({
            ...
            toolbar: ["excel"],
            excel: {
                fileName: "Consumption Issue Report.xlsx",
                allPages: true
            },
            columns: [
