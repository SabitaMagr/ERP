DTModule.controller('refrenceCodeCtrl', function ($scope, $rootScope, $http, $routeParams, $window, $filter, formtemplateservice) {
    ...
    $rootScope.refrenceCodeDataSource = {
        ...
        transport: {
            read: {
                url: "/api/ProjectTemplateApi/GetAllOrederNoByFlter"
            },
    ...
    $scope.refCustomerDataSource = {
        ...
        transport: {
            read: {
                //url: "/api/ProjectTemplateApi/" + purl,
                url: "/api/ProjectTemplateApi/GetAllCustomerSetupByFilter",
            },
            parameterMap: function (data, action) {
                var newParams;
                if (data.filter != undefined) {
        ...
        $scope.custReferenceGridOptions = {
            dataSource: {
                transport: {
                    read: {
                        type: "POST",
                        url: "/api/ProjectTemplateApi/bindReferenceGrid",
        ...
        $scope.referenceGridOptions = {
            ...
            dataBound: function (e) {
                $(".k-grouping-row").click(function (e) {
                    ...
                    var customernameurl = "/api/ProjectTemplateApi/getCustomerCode?customeredesc=" + expanded;
    ...
    function getVoucherDetailForReference(checkedItems) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/GetVoucherDetailForReferenceEdit";
                    ...
                    $scope.refrenceFn(response, function () {
                        ...
                        angular.forEach($scope.masterModels,
                            function (mvalue, mkey) {
                                ...
                                if (mkey === "CUSTOMER_CODE") {
                                    //old code
                                    //var req = "/api/ProjectTemplateApi/getCustEdesc?code=" + mvalue;
                                    ...
                                    var req = "/api/ProjectTemplateApi/GetCustomerInfoByCode?filter=" + mvalue;
                                    $http.get(req).then(function (results) {
                                        setTimeout(function () {
                        ...
                        angular.forEach($scope.childModels, function (cval, ckey) {
                            ...
                            if (cval.hasOwnProperty("ITEM_CODE")) {
                                var ireq = "/api/ProjectTemplateApi/getItemEdesc?code=" + cval.ITEM_CODE;
    ...
    reference.service('formtemplateservice', function (formtemplatefactory) {
    ...
    reference.factory('formtemplatefactory', function ($http) {
        var fac = {};
        fac.getFormDetail = function (formcode) {
            var req = "/api/ProjectTemplateApi/GetFormDetailSetup?formCode=";
            return $http.get(req + formcode);
        }
        fac.getDraftFormDetail = function (formcode) {
            var req = "/api/ProjectTemplateApi/GetDraftFormDetail?formCode=";
            return $http.get(req + formcode);
        }
        fac.GetFormCustomSetup = function (formcode, voucherNo) {
            var req = "/api/ProjectTemplateApi/GetFormCustomSetup?formCode=" + formcode + "&&voucherNo=" + voucherNo;
            return $http.get(req);
        }
        fac.getFormSetup = function (formcode) {
            var req = "/api/ProjectTemplateApi/GetFormSetupByFormCode?formCode=";
            return $http.get(req + formcode);
        }
        fac.getSalesOrderFormDetail = function (formcode, orderno) {

            var req = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/GetSalesOrderDetailFormDetailByFormCodeAndOrderNo?formCode=" + formcode + "&orderno=" + orderno;
            //return $http.get(req + formcode);
            return $http.get(req);
        }
        fac.getGrandTotalSalesOrder = function (orderno, formcode) {

            var req = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/GetGrandTotalByVoucherNo?voucherno=" + orderno + "&formcode=" + formcode;
            //return $http.get(req + formcode);
            return $http.get(req);
        }
        fac.getGrandTotalSalesOrderRef = function (orderno) {

            var req = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/GetREFGrandTotalByVoucherNo?voucherno=" + orderno;
            //return $http.get(req + formcode);
            return $http.get(req);
        }
        fac.getNewOrederNumber = function (companycode, formcode, currentdate, tablename) {

            var req = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/GetNewOrderNo?companycode=" + companycode + "&formcode=" + formcode + "&currentdate=" + currentdate + "&tablename=" + tablename + "&isSequence=false";
            //return $http.get(req + formcode);
            return $http.get(req);
        }
        ...
        fac.getDraftDataByFormCodeAndTempCode = function (formcode, tempCode) {
            var req = window.location.protocol + "//" + window.location.host + "/api/ProjectTemplateApi/getDraftDataByFormCodeAndTempCode?formCode=" + formcode + "&TempCode=" + tempCode;
            return $http.get(req);
        }
