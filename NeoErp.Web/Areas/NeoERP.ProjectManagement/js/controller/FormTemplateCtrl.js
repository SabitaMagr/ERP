...
PMModule.directive('financialform', function () {
...
PMModule.controller('FormTemplateCtrl', function ($scope, $rootScope, $http, $routeParams, formtemplateservice, $window, $filter, hotkeys) {
...
PMModule.service('formtemplateservice', function (formtemplatefactory) {
...
PMModule.factory('formtemplatefactory', function ($http) {
    var fac = {};
