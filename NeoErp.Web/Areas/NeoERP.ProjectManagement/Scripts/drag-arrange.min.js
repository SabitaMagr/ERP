...
(function (a) {
    ...
    function g(a, b, c) {
        ...
        for (var k, l, m, n, o, p, q, d = a.offset(), e = a.width(), f = a.height(), g = d.left, h = d.left + e, i = d.top, j = d.top + f, r = 0; r < c.length; r++)
            if (k = c.eq(r), k[0] !== b[0] && (n = k.offset(), l = n.left + .5 * k.width(), m = n.top + .5 * k.height(), o = l < h && l > g, p = m < j && m > i, q = o && p)) return k[0]
    }
     ...
     var b = "ontouchstart" in document.documentElement,
        ...
        a.fn.arrangeable = function (b) {
            ...
            function save() {
                ...
                var len = $(".FOLDER_ORDER").length;
                var data = [];
                for (var i = 0; i < len; i++) {
                    data.push({ 'FOLDER_ID': $($(".FOLDER_ORDER")[i]).text(), 'ORDER_NO': i })
                };
                ...
                $.ajax({
                    ...
                    url: "/Template/OrderNumberTemplate",
                    data: { fOLDER_ORDER: data },
                    dataType: "html",
