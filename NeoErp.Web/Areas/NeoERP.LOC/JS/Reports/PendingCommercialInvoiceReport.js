...
var urltest = window.location.protocol + "//" + window.location.host + "/api/LcReport/PendingCommercialInvoiceReport";
    ...
    var grid = $("#grid").kendoGrid({
            ...
            $.when.apply(null, detailExportPromises)
                .then(function () {
                    ...
                    kendo.saveAs({
                        ...
                        fileName: "Pending Commercial Invoice Report.xlsx",
                    });
                });
        },
        ...
        columnShow: function (e) {
            if ($(".k-widget.k-reset.k-header.k-menu.k-menu-vertical").is(":visible") && checkboxItem != "")
                SaveReportSetting('Pending Commercial Invoice Report', 'grid');
        },
