...
var urltest = window.location.protocol + "//" + window.location.host + "/api/LcReport/OpenLcReport";
var urlchildtemplate = window.location.protocol + "//" + window.location.host + "/api/LcReport/LcChildOpenLc?lctrackno=";
            ...
            $.when.apply(null, detailExportPromises)
                .then(function () {
                    ...
                    kendo.saveAs({
                        ...
                        fileName: "Opened Lc Report.xlsx"
                    });
                });
        },
...
function detailInit(e) {
    ...
    detailRow.find(".orders").kendoGrid({
        ...
        columns: [
            ...
            {
                field: "AMOUNT", title: "Rate", format: "{0:n}", attributes: { style: "text-align: right;" }, aggregates: ["sum"],
                footerTemplate: '<span style="float:right">#= kendo.toString(sum, "n")#</span>',
            },


            { field: "CURRENCY_CODE", title: "Currency" },
