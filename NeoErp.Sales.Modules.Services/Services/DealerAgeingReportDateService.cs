...
{
    public class DealerAgeingReportDateService:IAgeingReportDataService
    {
        private IDbContext _dbContext;
        private ICacheManager _cacheManager;
        private IWorkContext _workContext;
        public DealerAgeingReportDateService(IDbContext dbContext, ICacheManager cacheManager, IWorkContext workContext)
        {
